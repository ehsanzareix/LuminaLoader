import{a as e}from"./index-B-lxVbXh.js";import{L as y}from"./LuminaLoader-BR0IzzWk.js";import"./v4-CtRu48qb.js";import"./index-zspRAiHE.js";import"./api-1RnDu7Lw.js";const b={title:"Adapters/React/LuminaLoader",component:y,args:{theme:"auto"},argTypes:{onShow:{table:{disable:!0}},onHide:{table:{disable:!0}},theme:{control:{type:"radio",options:["auto","light","dark"]},description:"Theme to apply (auto adapts to prefers-color-scheme)"}}},o={args:{type:"spinner",show:!0,size:48,speed:1,onShow:e("onShow"),onHide:e("onHide")},argTypes:{size:{control:{type:"range",min:16,max:200}},speed:{control:{type:"number",min:.2,max:5,step:.1}},color:{control:"color"}}},r={args:{type:"image",image:'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="80" height="80"><rect width="100%" height="100%" fill="%23f3f4f6"/><circle cx="40" cy="40" r="24" fill="%234fa94d"/></svg>',imageAnimation:"rotate",size:80,show:!0,onShow:e("onShow"),onHide:e("onHide")}},n={args:{type:"progress",progressVariant:"linear",progress:45,size:200,show:!0,onShow:e("onShow"),onHide:e("onHide")}},a={args:{type:"spinner",overlay:!0,backdrop:{opacity:.5},show:!0,onShow:e("onShow"),onHide:e("onHide")}};var t,s,i;o.parameters={...o.parameters,docs:{...(t=o.parameters)==null?void 0:t.docs,source:{originalSource:`{
  args: {
    type: 'spinner',
    show: true,
    size: 48,
